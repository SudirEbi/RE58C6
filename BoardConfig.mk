...
TW_RECOVERY_ADDITIONAL_RELINK_LIBRARY_FILES += \
    ...
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/android.hardware.security.sharedsecret-V1-ndk.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/lib_android_keymaster_keymint_utils.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libcppbor_external.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libcppcose_rkp.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libgatekeeper.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libkeymaster_messages.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libkeymaster_portable.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/android.hardware.security.keymint-V3-ndk.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libkeymint.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libpuresoftkeymasterdevice.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libsoft_attestation_cert.so \
    $(TARGET_OUT_SHARED_LIBRARIES)/hw/libtrusty.so \
    ...
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/android.hardware.gatekeeper@1.0.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/android.hardware.security.keymint-V1-ndk.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/lib_android_keymaster_keymint_utils.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libcppbor_external.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libcppcose_rkp.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libkeymaster_messages.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libkeymaster_portable.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libkeymint.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libpuresoftkeymasterdevice.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libsoft_attestation_cert.so \
    $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)/hw/libtrusty.so \
